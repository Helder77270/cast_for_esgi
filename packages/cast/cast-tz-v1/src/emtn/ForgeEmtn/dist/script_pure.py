...
class ForgeEmtn(sp.Contract):
    ...
    def upgrade(self, params):
        ...
        with sp.for_('x', params.items()) as x:
    ...
    def run(self, params):
        ...
        with sp.if_((params.entrypointName == LAMBDA.AUTHORIZE_OPERATOR)):
            self.callOperatorEventSink(
                params._operator, params._operatorRole, "newOperator")
        with sp.if_((params.entrypointName == LAMBDA.REVOKE_OPERATOR_AUTHORIZATION)):
            self.callOperatorEventSink(
